...
const original={clients:[{id:'qa-client',commercialName:'Cliente de demostración',status:'Activo'}],employees:[],tickets:[],projects:[],serviceReports:[]};
...
const runtime=createApp({directory:path.join(folder,'preview-reports-data'),legacyFile:legacy,worker:false});
